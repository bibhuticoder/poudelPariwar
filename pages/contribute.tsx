    ...
    <div className="pt-16">
      ...
      <div className="container font-Nunito">
        ...
        <div className="text-xl">
          ...
          <p className="mb-4">
            <b>Technical</b>: If you are a programmer, you can help us by improving the source code. The project is kept open-source at <a href="http://" target="_blank" rel="noreferrer"  className="site-link">Github</a>.
